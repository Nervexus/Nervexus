...
(function (root) {
  ...
  var MAP = {
    ...
    'landmine lateral raise':                ['Shoulders',  'Shoulders', 'Landmine Lateral Raise'],
    ...
    'gravedigger':                           ['Shoulders',   'Shoulders',  'Gravedigger'],
    ...
    'landmine squat':                        ['Quads',      'Legs',      'Landmine Squat'],
    'landmine lunge':                        ['Quads',      'Legs',      'Landmine Lunge'],
    'stiff leg deadlift':                    ['Hamstrings', 'Legs',      'Stiff-Leg Deadlift'],
    'landmine deadlift':                     ['Hamstrings', 'Legs',      'Landmine Deadlift'],
