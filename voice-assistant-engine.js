  ...
  var TOOLS = [
    ...
    { name: 'travel_brief', desc: 'Give a live travel brief for a city (weather, safety, customs, currency, transport).', params: 'city (string)',
      run: async function (a, host) {
        ...
        var res = await host.askLive('Give a concise spoken travel brief for a trip to ' + a.city + ': current weather, local safety notes (balanced, not alarmist), customs/etiquette, currency, and typical transport options. Keep it tight for speech, a few sentences per topic.');
