...
(function (root) {
  ...
  var TOOLS = [
    ...
    { name: 'stop_assistant', desc: 'Turn the voice assistant off / stop listening — user says things like "you can turn off", "stop listening", "that\u2019ll be all", "go to sleep".', params: 'none',
      run: async function (a, host) { host.tools.disableAssistant(); return 'Okay, turning off. Say the wake word or flip the switch to bring me back.'; } },
  ...
  var FALLBACK_INTENTS = [
    ...
    { re: /(?:give me|what.?s|brief me on|start|play|hear|i want|can i (?:get|hear))(?: my|:)?(?: today.?s| daily)? briefing|brief me\b|daily briefing/i, tool: 'read_source', args: function () { return { id: 'brief' }; } },
