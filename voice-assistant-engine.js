...
(function (root) {
  ...
  var TOOLS = [
    { name: 'navigate', desc: 'Open a screen in the app.', params: 'scene (one of: home, finance, health, fitness, business, globe, briefing, power, calendar, productivity, checklists, voice, settings)',
